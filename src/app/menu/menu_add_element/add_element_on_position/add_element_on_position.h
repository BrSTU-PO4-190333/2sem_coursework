#ifndef _ADD_ELEMENT_ON_POSITION_H_
    #define _ADD_ELEMENT_ON_POSITION_H_
    ...
    void add_element_on_position(struct reservoirs_of_the_country*, int);
    void input_fields(struct reservoirs_of_the_country*, int);
#endif